...
| 35 | `whmcs_get_products` | GetProducts | READ | on | 🟢 | Lista produtos com fields=lite (default), envelope ≤40 KB e cursor `next_limitstart`; `product_url` só com `fields=full` + `include_urls=true`, sempre relativa |
