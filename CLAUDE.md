...
- Trusted proxy IP: `IpResolver::resolve()` — rightmost-untrusted from X-Forwarded-For; proxies configurados via `nt_mcp_trusted_proxies` (CSV de IPs/CIDRs em tblconfiguration)
